...
HD_PWD='/home/ggjiji/Project/Accelator/Accelator.runs/parameter_sram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parameter_sram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parameter_sram.tcl
