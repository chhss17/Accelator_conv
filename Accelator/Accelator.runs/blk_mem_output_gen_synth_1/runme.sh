...
HD_PWD='/home/ggjiji/Project/Accelator/Accelator.runs/blk_mem_output_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_output_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_output_gen.tcl
